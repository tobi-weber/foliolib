...
from foliolib.raml.exceptions import CodeBuilderError, RamlResourceTypeNotFound
from foliolib.raml.helper import merge_dict, pluralize, singularize
from foliolib.raml.ramlMethod import RamlMethod

log = logging.getLogger("foliolib.raml.ramlUrl")
