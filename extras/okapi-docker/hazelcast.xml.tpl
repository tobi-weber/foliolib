...
<hazelcast xmlns="http://www.hazelcast.com/schema/config"
    ...
    <cluster-name>okapi</cluster-name>
    ...
    <network>
        ...
        <join>
            <multicast enabled="MULTICAST_BOOLEAN">
            ...
            <kubernetes enabled="KUBERNETES_BOOLEAN">
                <namespace>KUBERNETES_NAMESPACE</namespace>
                <service-name>KUBERNETES_SERVICE_NAME</service-name>
